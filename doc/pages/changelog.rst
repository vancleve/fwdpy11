...
------------------------------------------
* Refactored single-locus evolution code, fixing error with stateful fitness models. [`commit <https://github.com/molpopgen/fwdpy11/commit/80c3ba8e60ee402cb8e1bfd743501a328d3ca258>`_]
